  ...
  return (
    ...
    <Row className="mb-3">
      ...
      <InputField
        ...
        require={true}
      />
      <Form.Group as={Col} md="12" className="bg-transparent p-3" controlId="validationCustom06">
        <Form.Label>Upload picture of your NIN slip</Form.Label>
        <Form.Control type="File" placeholder="upload a picture of your NIN slip" required />
